...
try:
    ...
    try:
        from core.word_report import generate_factory_word as _gfw
        generate_factory_word = _gfw
    except ImportError:
        generate_factory_word = None
...
<div class="fiti-header">
  <div class="fiti-logo-wrap">
    ...
    <div>
      ...
      <div class="fiti-app-sub">제품평가팀 / Products Evaluation Team</div>
    </div>
  </div>
</div>
""", unsafe_allow_html=True)
    ...
    if ranking:
        ...
        if selected_factory:
            ...
            if detail:
                ...
                _dl_cols = st.columns(2) if generate_factory_word else [st.container()]
                with _dl_cols[0]:
                ...
                if generate_factory_word and len(_dl_cols) > 1:
                    with _dl_cols[1]:
